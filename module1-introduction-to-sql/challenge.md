...
#### In the **Northwind database** Employees have a relationship where one employee may only have one territory associated with it (via the Territory ID).  But a territory may have many Employees assigned to it.  (One to Many)


#### I think a situation where a **document store might be appropriate** when you expect a lot of data but are not sure how you categorize it initially.  If you were taking surveys with open ended responses.  If you had an open world video game and you were cataloging user generated content.  If you were a start up and thought you might have to pivot your business model after getting user feed back.  Document store would allow you to manage the data and establish more formal relationship between units at a later time.  
	It would not be appropriate when you have a mature business model, and manageable data sizes.  

#### **NewSQL is trying to that the best of both world** from SQL based and NoSQL style management systems.  It wants to be flexibilty and (horizontally)scalable like NoSQL, but have a higher level of consistency like SQL style DBMS. 
